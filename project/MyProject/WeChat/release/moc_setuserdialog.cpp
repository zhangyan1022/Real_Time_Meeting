...
QT_MOC_LITERAL(1, 14, 13), // "SIG_setCommit"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 6), // "iconid"
QT_MOC_LITERAL(4, 36, 4), // "name"
QT_MOC_LITERAL(5, 41, 7), // "feeling"
QT_MOC_LITERAL(6, 49, 17) // "on_pb_set_clicked"

    },
    "SetUserDialog\0SIG_setCommit\0\0iconid\0"
    "name\0feeling\0on_pb_set_clicked"
};
...
void SetUserDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        SetUserDialog *_t = static_cast<SetUserDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->SIG_setCommit((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2])),(*reinterpret_cast< QString(*)>(_a[3]))); break;
        case 1: _t->on_pb_set_clicked(); break;
        default: ;
        }
        ...
        {
            typedef void (SetUserDialog::*_t)(int , QString , QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SetUserDialog::SIG_setCommit)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject SetUserDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_SetUserDialog.data,
      qt_meta_data_SetUserDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SetUserDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SetUserDialog.stringdata0))
        return static_cast<void*>(const_cast< SetUserDialog*>(this));
...
// SIGNAL 0
void SetUserDialog::SIG_setCommit(int _t1, QString _t2, QString _t3)
{
